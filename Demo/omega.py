...
@import url('https://api.fontshare.com/v2/css?f[]=cabinet-grotesk@800,900,700&f[]=satoshi@300,400,500,700,900&f[]=jetbrains-mono@300,400,500,700&display=swap');
...
:root {
    ...
    --font-sans: 'Satoshi', 'Cabinet Grotesk', -apple-system, BlinkMacSystemFont, sans-serif;
...
h1, h2, h3, h4, h5, h6, .omega-brand-name, .main-wordmark, .card-title {
